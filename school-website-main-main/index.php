                ...
                if (receive_response) {
                    switch (receive_response[0]) {
                        ...
                        case "student":
                            ...
                            break;
                        case "Failed":
                            alert("Please check your username and password or create an account if you don't have one.");
                            break;
                        case "No_Network":
                        default:
...
function register() {
    ...
    } else if (username.length < 6 || password.length < 10) {
        alert("Username must be at least 6 characters and password at least 16 characters.");
    } else {
        $.ajax({
            url: "function.php",
            type: "POST",
            data: { cu: username, cp: password },
            dataType: "text",
            success: function (response) {
